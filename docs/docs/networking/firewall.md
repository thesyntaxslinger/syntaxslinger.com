...
My firewall setup is fairly straightforward but intentionally restrictive. The goal is to minimise exposure while maintaining functionality across both LAN and WAN environments.
...
Since this is a homelab environment, there isn't really much firewalling for me to be doing. I am on a separate VLAN to the untrusted devices, and everything here is relatively already pretty restrictive.
